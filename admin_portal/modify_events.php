...
<div class="main">
    <div class="about_main_divide">
        ...
        <form action="" method="POST" enctype="multipart/form-data" class="nss-form" onsubmit="return validateForm();">
            ...
            <input type="text" id="event_name" maxlength="25" name="event_name" value="<?= $event['event_name'] ?? '' ?>"><br><br>

            <label for="event_desc">Event Description:</label>
            <textarea id="event_desc" maxlength="255" name="event_desc"><?= $event['event_desc'] ?? '' ?></textarea><br><br>
